---
'@lucass-hsa1/facilities-client': minor
---

Cliente fetch tipado pra Facilities-Hub (Fase 6 do plano).
...
```ts
import { createFacilitiesClient, createFacilitiesClientFromEnv } from '@lucass-hsa1/facilities-client'
...
const result = await hub.image.compress(buffer, { maxWidth: 1200, format: 'auto' })
```
